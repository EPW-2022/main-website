    ...
    <div class="about-gallery mx-auto">
      <div class="owl-carousel owl-theme owl-loaded">
        <div class="owl-stage-outer">
          <div class="owl-stage">
            <div class="owl-item gallery-photo">
              <img src="/img/snow/snow-photo1.JPG" class="w-100" alt="">
            </div>
            <div class="owl-item gallery-photo">
              <img src="/img/snow/snow-photo2.JPG" class="w-100" alt="">
            </div>
            <div class="owl-item gallery-photo">
              <img src="/img/snow/snow-photo3.JPG" class="w-100" alt="">
            </div>
            <div class="owl-item gallery-photo">
              <img src="/img/snow/snow-photo4.png" class="w-100" alt="">
            </div>
            <div class="owl-item gallery-photo">
              <img src="/img/snow/snow-photo5.png" class="w-100" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="description">
      ...
      <div class="description-theme my-3">
        <div class="row align-items-center">
          ...
          <div class="col-md-7 col-lg-9">
            <p class="theme-desc text-center text-md-start">Innovation of Technology in Humanity for realizing the Sustainable Development Goals.
            </p>
          </div>
        </div>
      </div>
      <div class="description-subtheme my-3">
        <div class="row align-items-center">
          ...
          <div class="col-md-7 col-lg-9">
            <div class="subtheme-desc text-center text-md-start">
              <div class="row">
                <div class="col-md">
                  <ul class="subtheme-list">
                    <li class="subtheme-item">Renewable Energy</li>
                    <li class="subtheme-item">Waste to Energy</li>
                    <li class="subtheme-item">Good Health</li>
                  </ul>
                </div>
                <div class="col-md">
                  <ul class="subtheme-list">
                    <li class="subtheme-item">Climate Chance</li>
                    <li class="subtheme-item">Internet of Things</li>
                  </ul>
                </div>
              </div>
            </div>
...
<section id="snow-prize">
  ...
  <div class="prize">
    <div class="prize-header">
      <h2 class="prize-title mx-auto text-center">REWARD</h2>
      <hr class="header-line">
      <hr class="header-line">
      <hr class="header-line">
    </div>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="prize-content mx-auto">
          <h3 class="prize-category text-center">Presentasi</h3>
          <div class="prize-detail ps-5 d-flex justify-content-center flex-column text-center">
            <div class="prize-container">
